...
│
├── server/
│   ├── index.js             # Express API mit Crawling (600+ Zeilen)
...
│   └── AI_SERVICES.md       # KI-Service Setup & Anleitung
│
...
- **API-Endpoints**: 
  ...
  - `GET /docs/:filename` - Dokumentation abrufen
...
- **[/docs/AI_SERVICES.md](/docs/AI_SERVICES.md)** - Detaillierte KI-Service Anleitung:
  - Setup für alle 5 Services (OpenAI, Claude, Gemini, Ollama, Local)
  - Modelle, Pricing, Performance
...
- KI-Services Dokumentation in /docs/AI_SERVICES.md

### Error Handling
- Try-Catch auf alle API Calls
- User-freundliche Fehlermeldungen
- Validierungsfunktionen extrahiert

### Accessibility
- ARIA-Labels auf allen Inputs
...
**Für detaillierte Setup-Anleitung siehe [/docs/AI_SERVICES.md](/docs/AI_SERVICES.md)**
...
**Dokumentation**: Hilfe-Modal + /docs/AI_SERVICES.md ✅
